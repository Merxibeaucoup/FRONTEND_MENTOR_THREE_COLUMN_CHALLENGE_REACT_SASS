...
const Box = () => {
  return (
    <div className="box">
      <div className="box__colwrapper">
        <div className="box__column box__column-1">
          <div className="box__column__icon">
          ...
          <h2 className="box__column__heading">sedans</h2>
          <p className="box__column__paragraph">
            Choose a sedan for its affordability and excellent fuel economy.
            Ideal for cruising in the city or on your next road trip.{" "}
          </p>

          <a href="#/" className="box__column__link box__column__link-1">
            Learn more
          </a>
        </div>
        <div className="box__column box__column-2">
          <div className="box__column__icon">
            <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
              <g fill="none" fill-rule="evenodd">
                <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
          ...
          <h2 className="box__column__heading">suvs</h2>
          <p className="box__column__paragraph">
            Take an SUV for its spacious interior, power, and versatility.
            Perfect for your next family vacation and off-road adventures.{" "}
          </p>

          <a href="#/" className="box__column__link box__column__link-2">
            Learn more
          </a>
        </div>
        <div className="box__column box__column-3">
          <div className="box__column__icon">
            <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
              <g fill="none" fill-rule="evenodd">
                <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
          ...
          <h2 className="box__column__heading">luxury</h2>
          <p className="box__column__paragraph">
            Cruise in the best car brands without the bloated prices. Enjoy the
            enhanced comfort of a luxury rental and arrive in style.
          </p>

          <a href="#/" className="box__column__link box__column__link-3">
            Learn more
          </a>
        </div>
      </div>
